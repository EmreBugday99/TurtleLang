#include "instruction_callback_stack_jump_compare.h"

#include "instruction_callback_jump.h"
#include "../program/program.h"
#include "../data_types/stack.h"

enum instruction_result instruction_callback_stack_jump_compare(void* program, vm_data data)
{
	...
	if (cache1 == cache2)
		instruction_callback_jump(program, data);
